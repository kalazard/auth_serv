...
class LoginServer{
	...
	//fonction qui test si l'utilisateur en argument existe
	function CheckLogin()
	{
...
$serversoap=new SoapServer("http://130.79.214.167/auth_serv/wsdl/serv.wsdl");
...
$serversoap->setClass("LoginServer");
